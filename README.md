...
**hello-rails-react** is an exercise at Microverse in preparation for our final capstone project where we had a group of 4-5 students work as a team to develop a fullstack app using Rails on the backend and React on the front end. In the exercise we build a simple project with Rails and React as a single monolithic app with React and Rails in a single repo
...
- **Built using MVC**
- **Backend and Frontend in a single repo**
...
<pre>https://github.com/kkolade/hello-rails-react.git</pre>
